/*****************************************************************************/
/*                                                                           */
/*  Module Name     : HAPI_C16.H                                             */
/*                                                                           */
/*  Description     : 16 Bit HLLAPI Structure, Return Codes and Routines     */
/*                                                                           */
...
/*  Function:                                                                */
/*                                                                           */
/*    Define the 16 Bit HLLAPI structure, return code constants and          */
...
#define ord_hllapi  3
#define ord_hllapiw 4

extern void far pascal hllapi(LPINT, LPSTR, LPINT, LPINT);
extern void far pascal hllapiw(HWND, LPINT, LPSTR, LPINT, LPINT);

#include "hllstr16.h"                   /* 16 bit structure definitions */
