...
function EncryptFubonString( PlainText : AnsiString ) : AnsiString ;
function  DecryptFubonString( EncryptString : AnsiString ): AnsiString ;
...
begin
  ...
  Source := TStringStream.Create( PlainText );
...
begin
  ...
  Source := TStringStream.Create( HexToString( EncryptString ));
  Dest   := TStringStream.Create( '' );
  PWD := 'fubon730522' ;
  try
    // Start decryption...
